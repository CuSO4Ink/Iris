...
> [!CAUTION] **2026-07-22：旧 headless 架构草案。**
> 实际已落地为 qrenderdoc 扩展＋文件 IPC＋Replay API＋MCP；本文工具表和实施计划不得继续充当当前 BACKLOG。
...
> [!NOTE] 参考 [UEAgent MCP 坑册](../../work/UEAgent/notes/mcp-pitfalls.md)：子进程环境不继承 shell，spawn MCP 时 `python` 可能找不到，需写绝对路径。
> — ai 2026-07-10
