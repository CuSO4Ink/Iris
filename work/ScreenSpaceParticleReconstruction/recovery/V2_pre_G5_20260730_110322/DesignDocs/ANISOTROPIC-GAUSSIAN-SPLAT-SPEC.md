...
- 版本：0.4
- 日期：2026-07-29
- 状态：待用户审批；G0～G4 技术链已完成，G4 虽降低粒子感但产生明显过度模糊，现提议进入 G5“方向张量 + 粒子深度场 + 无历史 Streamline”
...
审批通过后的第一步只实施 G5.1/G5.2 字段生成与 Debug Gate，不立即合成最终烟雾。方向、Coherence、MeanDepth、DepthSigma 和 FrontDepth 都通过用户观察后，再接入 Streamline 与深度受光。
