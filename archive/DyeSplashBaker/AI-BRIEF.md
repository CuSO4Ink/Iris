...
已归档（2026-07-02）。主线方案（FloodStep v2 到达时间场烘焙）稳定，2026 年 5-6 月推进了配套运行时贴花系统（地面+墙面双通道 Decal，含多射线障碍遮挡、墙面流挂/团块材质、Progress 反向阈值动画），与烘焙纹理链路完全打通；当前保留为技术资产，不再作为进行中项目维护。
